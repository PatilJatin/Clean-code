...
export interface UpdateClientTagCategoryUsecase {
  execute: (
    tagCategoryId: string,
    tagCategoryData: ClientTagCategoryEntity
  ) => Promise<Either<ErrorClass, ClientTagCategoryEntity>>;
}

export class UpdateClientTagCategory implements UpdateClientTagCategoryUsecase {
  ...
  async execute(
    clientTagCategoryId: string,
    clientTagCategoryData: ClientTagCategoryEntity
  ): Promise<Either<ErrorClass, ClientTagCategoryEntity>> {
    return await this.clientTagCategoryRepository.updateClientTagCategory(clientTagCategoryId, clientTagCategoryData);
  }
}
