import { UpdateAdmin, UpdateAdminUsecase } from '@domain/admin/usecases/update-admin';
...
describe('UpdateAdmin', () => {
    ...
    it('should update an admin', async () => {
        ...
        const result: Either<ErrorClass, AdminEntity> = await updateAdmin.execute(adminId, updatedAdminData);
        ...
        expect(mockAdminRepository.updateAdmin).toHaveBeenCalledWith(adminId, updatedAdminData);
    });
